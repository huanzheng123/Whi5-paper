...
close all;
plot_log_exp(boundtime_extr5_w,'r');
hold on;
plot_log_exp(boundtime_extr5_s,'g');
hold on;
plot_log_exp(boundtime_extr5_o,'b');
hold on;
plot_log_exp(boundtime_extr5_m,'k');

%legend('Whi5-Halo','Swi4-Halo','Swi4-Halo in Whi5-overexpression','Swi4-Halo in Mbp1-deletion','Location','southwest')
title('Whi5-Halo');
%%
[h,p] = ttest(boundtime_extr5_s,boundtime_extr5_o);

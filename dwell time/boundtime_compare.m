% compare the bound time of different datasets 
filename= '*MS563*merge_Darea_Dwellres*%d.mat';
celltype = [3 5];
sizethre = [30 130];
boundtime_extr1 = boundtimecal(celltype,sizethre,filename);

celltype = [4 6];
sizethre = [10 60];
boundtime_extr2 = boundtimecal(celltype,sizethre,filename);
...
filename2= '*YHZ68*merge_Darea_Dwellres*%d.mat';
celltype = [3 5];
sizethre = [60 150];
boundtime_extr5 = boundtimecal(celltype,sizethre,filename2);
celltype = [4 6];
sizethre = [30 80];
boundtime_extr6 = boundtimecal(celltype,sizethre,filename2);

celltype = [4 6];
sizethre = [30 50];
boundtime_extr7 = boundtimecal(celltype,sizethre,filename2);

celltype = [4 6];
sizethre = [60 80];
boundtime_extr8 = boundtimecal(celltype,sizethre,filename2);
...
close all;
duration = [boundtime_extr1',boundtime_extr5',boundtime_extr2',boundtime_extr8'];
...
function boundtime_extr = boundtimecal(celltype,sizethre,filename)
